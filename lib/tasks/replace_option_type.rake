...
#       option_type.option_values << Spree::OptionValue.create(name: row['Option Value'], presentation: row['Option Value'], image: File.new(Rails.root.join('public', 'option_values', (row['Option Value'] + ".jpg")) ))
#     end
#   end
# end
